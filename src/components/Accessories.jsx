...
const ACCESSORIES = [
    { icon: Shield, name: 'Películas', desc: 'Vidro 3D, 9D e Gel' },
    { icon: Smartphone, name: 'Capinhas', desc: 'Anti-impacto e Silicone' },
    { icon: Headphones, name: 'Fones', desc: 'Bluetooth e Com Fio' },
    { icon: BatteryCharging, name: 'Carregadores', desc: 'Turbo e Portáteis' },
    { icon: Cable, name: 'Cabos', desc: 'iPhone, Tipo-C e V8' },
    { icon: Car, name: 'Suportes', desc: 'Veicular e Mesa' },
];

const AccessoryCard = ({ icon: Icon, name, desc, index }) => (
    <motion.article
    ...
    >
        ...
        <h3 className="font-bold mb-1 group-hover:text-dark transition-colors">{name}</h3>
        <p className="text-xs text-gray-500 group-hover:text-dark/70 transition-colors">{desc}</p>
    </motion.article>
);
