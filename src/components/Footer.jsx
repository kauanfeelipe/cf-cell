        ...
        <footer className="bg-dark-surface border-t border-white/5 pt-10 pb-6">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4 mb-8">
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-1 flex flex-col justify-between items-center lg:items-start">
                        <div className="text-center lg:text-left">
                            <h3 className="text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r from-primary via-white to-primary bg-clip-text text-transparent animate-shine bg-[length:200%_auto] drop-shadow-[0_0_15px_rgba(255,215,0,0.5)] italic tracking-wider">CF CELL</h3>
                            <a
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>R. Espírito Santo, 618<br />Centro - Nuporanga/SP</span>
                            </li>
                            <li className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-sm">
                            <li><a href="#services" className="text-gray-400 hover:text-primary transition-colors">Assistência Técnica</a></li>
                            <li><a href="#products" className="text-gray-400 hover:text-primary transition-colors">Celulares à Venda</a></li>
                            <li><a href="#accessories" className="text-gray-400 hover:text-primary transition-colors">Acessórios</a></li>
                            <li><a href="#about" className="text-gray-400 hover:text-primary transition-colors">Quem Somos</a></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/5 pt-6 text-center text-gray-600 text-xs">
                    <p>&copy; 2025 CF CELL. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
    );
